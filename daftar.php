...
<head>
  ...
  <!-- css -->
  <link rel="stylesheet" href="assets/css/lrs.css" />
  ...
  <nav class="navbar navbar-expand-lg navbar-light nav-block">
    <div class="container">
      <a class="navbar-brand" href="index.php">
        <img src="assets/img/logo/sebat-bw.png" alt="Logo" />
      </a>
    ...
    <div class="row justify-content">
      <div class="col-lg-6">
        <div class="about-img wow fadeInUp img-reset" data-wow-delay=".5s">
          <img src="assets/img/form/register.svg" alt="">
        </div>
      </div>
      <div class="col-lg-6 kanan">
        <form action="#" method="POST" class="input-form daftar">
          <h1>Daftar</h1>
          <div class="wrapp wrap-daftar">
            ...
            <div class="input-wrap">
              ...
              <input type="email" name="password" autocomplete="off">
            </div>
            <div class="input-wrap">
