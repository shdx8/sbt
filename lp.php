...
<head>
  ...
  <title>SeBat - Sewa Baterai</title>
    ...
    <div class="container d-flex align-items-center">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="index.php">
            <img src="assets/img/logo/sebat-bw.png" alt="">
          </a></h1>
      ...
      <a href="login.php" class="get-started-btn">Get Started</a><!-- .nav-menu -->
      ...
      <div class="row">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>Isi ulang baterai smartphone anda dengan <span>SeBat</span></h1>
            <h2>Peminjaman baterai</h2>
        ...
        <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
          <img src="assets/img/hero/hero.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div
            ...
            data-aos="fade-left">
            <h3>Halo, Kami dari SeBat</h3>
            <p>Layanan peminjaman Powerbank berbasis web di Indonesia. Memberikan layanan terbaik kepada seluruh
              pengguna diseluruh Indonesia.</p>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right">
            <img src="assets/img/features/features-1.svg" class="img-fluid" alt="">
          </div>
          <div class="col-md-8 pt-4" data-aos="fade-up">
            <h3>SeBat tersedia di berbagai lokasi.</h3>
            <p class="font-italic">
            ...
            <ul>
              <li><i class="icofont-check"></i> Pusat Pebelanjaan.</li>
              <li><i class="icofont-check"></i> Restoran.</li>
              <li><i class="icofont-check"></i> Minimarket.</li>
              <li><i class="icofont-check"></i> Cafe.</li>
            </ul>
            <p>
        ...
        <div class="row content">
          <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
            <img src="assets/img/features/features-2.svg" class="img-fluid" alt="">
          </div>
          <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
            ...
            <p>
              Biaya peminjaman SeBat sangat terjangkau dan ga bakal bikin kamu kanker(kantong kering).
            </p>
            <p>
        ...
        <div class="row content">
          <div class="col-md-4" data-aos="fade-right">
            <img src="assets/img/features/features-3.svg" class="img-fluid" alt="">
          </div>
